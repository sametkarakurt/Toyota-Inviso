...
const FormScreen = ({route,navigation}) => {
  ...
  const fields = [
    {value:"Input Number",type:"numberComponent"},
    {value:"Input Date",type:"dateComponent"},
    {value:"Input Email",type:"emailComponent"},
    {value:"TextArea",type:"textAreaComponent"},
    {value:"MultiSelect",type:"multiSelectComponent"},
    {value:"Selectbox",type:"selectBoxComponent"},
    {value:"Checkbox",type:"chechBoxComponent"},
    {value:"RadioButton",type:"radioButtonComponent"},
    {value:"Fotoğraf Çek",type:"cameraComponent"},
    {value:"RECORD VIDEO",type:"videoComponent"},
            ...
            if(comp.options[0]){
              ...
              fields.forEach(item => {
                ...
                if(item.value ===  comp.options[0].key ){
                  ...
                  setTypeArray(oldArray => [...oldArray, item.type])
                }
