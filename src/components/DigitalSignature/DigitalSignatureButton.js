...
import DigitalSignatureImage from './DigitalSignatureImage';
...
const DigitalSignatureButton = (props) => {
  ...
  <Box>
               <Heading marginBottom={5} fontSize="lg">Dijital İmza</Heading>
               <HStack>
               <Image
                           ...
                           />
                            <TouchableOpacity style={{ color: "white" ,alignItems:'flex-start',justifyContent:'flex-start',marginLeft:-25}} onPress={removeSignature}>
